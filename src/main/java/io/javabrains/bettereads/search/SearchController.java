...
public class SearchController {
        ...
        public String getSearchResults(@RequestParam String query, Model model) {
                ...
                Mono<SearchResult> searchResult = this.webClient.get()
                                .uri("?q={query}", query)
                                .retrieve().bodyToMono(SearchResult.class);

                SearchResult result = searchResult.block();

                List<BookResult> bookResults = result.getDocs()
                                .stream()
                                .limit(10)
                                .map(bookResult -> {
                                        ...
                                        if (StringUtils.hasText(coverId)) {
                                                ...
                                                coverId = "images/No_image_available.svg.webp";
                                        }
                ...
                model.addAttribute("searchResults", bookResults);
